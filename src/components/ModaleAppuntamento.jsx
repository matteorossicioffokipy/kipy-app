...
export default function ModaleAppuntamento({ formApp, setFormApp, onSalva, onAnnulla, isEdit }) {
  ...
  return (
    <div
      ...
      style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.45)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '0', boxSizing: 'border-box' }}
    >
      <div style={{ background: 'white', borderRadius: '0', padding: '24px', width: '100%', maxWidth: '100%', boxSizing: 'border-box', boxShadow: 'none', height: '100vh', overflowY: 'auto' }}>
