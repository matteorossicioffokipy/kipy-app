...
const tabBtn = (active, color) => ({ flex: 1, border: 'none', background: active ? color : 'transparent', color: active ? 'white' : '#64748B', padding: '8px 4px', borderRadius: '10px', cursor: 'pointer', fontWeight: '700', fontSize: '13px', fontFamily: "'Baloo 2', sans-serif", whiteSpace: 'nowrap', minWidth: 0 });
